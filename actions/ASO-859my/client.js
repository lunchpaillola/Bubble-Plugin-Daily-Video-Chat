    ...
    if (window.callFrame !== undefined) {
        ...
        switch (properties.layout) {
            case 'single-participant':
                ...
                addOptions(['height', 'width', 'videoBitrate', 'audioBitrate', 'maxDuration','backgroundColor', 'minIdleTimeOut','fps','rtmpUrl']);
                break;
            ...
            default:
                ...
                addOptions(['height', 'width','videoBitrate', 'audioBitrate','fps','maxDuration', 'minIdleTimeOut', 'backgroundColor', 'rtmpUrl']);
                break;
        }
        ...
        callFrame.startLiveStreaming(liveStreamingOptions);
    }  
